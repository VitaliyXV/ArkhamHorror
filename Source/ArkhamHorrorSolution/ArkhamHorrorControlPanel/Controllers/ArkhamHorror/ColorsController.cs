...
namespace ArkhamHorrorControlPanel.Controllers.ArkhamHorror
{
    public class ColorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,OriginalName,LocalName")] Color color)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,OriginalName,LocalName")] Color color)
        {
            if (ModelState.IsValid)
            {

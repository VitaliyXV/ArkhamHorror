...
insert into Abilities (OriginalName, LocalName, [Description], Value) values (N'Ambush', N'Засада', N'Из боя с таким монстром отступить нельзя, сыщик должен драться до победы или поражения.', 0);
...
insert into Monsters (OriginalName, LocalName, [Description], GameExtention, MonsterMoveType, MonsterType,
			...
			values	(N'Formless Spawn', N'Бесформенная тварь', N'Из мрака глухого переулка вырвалось пятно тени. Оно взвилось по кирпичной стене и заступило нам путь.',
						1, 1, 1, 2, 1, 0, -1, 2, -2, 2);

insert into MonstersAmount (Monster, GameExtention, Amount) values (1, 1, 2);

insert into MonstersAbilities (Monster, Ability) values (1, 1);
